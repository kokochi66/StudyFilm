...
<section class="page-section portfolio" id="portfolio">
    <div class="container">
        ...
        <form:form modelAttribute="member" action="setup" id="registForm" cssClass="col-5 m0auto">
        	...
        	<form:select path="job" cssClass="form-control" items="${jobList}" itemValue="value" itemLabel="label" /> 
        	<font color="red"><form:errors path="job" /></font><br>
