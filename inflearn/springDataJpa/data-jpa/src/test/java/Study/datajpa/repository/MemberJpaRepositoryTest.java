...
class MemberJpaRepositoryTest {
    ...
    @Test
    public void paging() {
        memberJpaRepository.save(Member.createMember("kokochi1", 20));
        memberJpaRepository.save(Member.createMember("kokochi2", 20));
        memberJpaRepository.save(Member.createMember("kokochi3", 20));
        memberJpaRepository.save(Member.createMember("kokochi4", 20));
        memberJpaRepository.save(Member.createMember("kokochi5", 20));
    ...
    public void bulkUpdate() {
        memberJpaRepository.save(Member.createMember("kokochi1", 10));
        memberJpaRepository.save(Member.createMember("kokochi2", 19));
        memberJpaRepository.save(Member.createMember("kokochi3", 25));
        memberJpaRepository.save(Member.createMember("kokochi4", 99));
        memberJpaRepository.save(Member.createMember("kokochi5", 50));
